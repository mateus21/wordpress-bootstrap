...
<footer>
    <div class="container">
        <div class="col-sm-3">
            <p><a href="/"><img src="<?= get_stylesheet_directory_uri(); ?>/assets/img/logo.png" alt="Bootstrap to WordPress"></a></p>
        </div><!-- end col -->
        <div class="col-sm-6">
            <nav>
...
<script src="<?= get_stylesheet_directory_uri() ?>/assets/js/jquery-2.1.1.min.js"></script>
